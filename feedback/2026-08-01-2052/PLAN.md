...
Zuordnung aller 95 Punkte aus [FEEDBACK.md](FEEDBACK.md). **Kein Code geändert.**
...
| `VMI` | `src/components/VModelInteractive.tsx` |
...
Diese Fragen blockieren die 17 ENTSCHEIDUNG-Punkte. Für den Reply ins Pastel-Canvas:

1. **#112** — Eyebrow und H1 der Agentic-Seite sollen laut #111/#112 beide
   „AI-Enhanced WBG Semiconductor Engineering" heißen. Welcher der beiden trägt den Begriff,
   und was steht im anderen?
2. **#133–#141** — Gehören der „Time-to-Market"-Header und die sechs Wissensgraph-Bausteine in
   dieselbe Sektion? Falls nicht: welchen Eyebrow/Headline/Body bekommen die sechs Bausteine?
3. **#117** — „Process-Flow design-technisch aufwerten": Die Frage ist direkt an dich (Adrien)
   adressiert. Vorschlag nötig, bevor die vier Labels final gesetzt werden.
4. **#160** — Zugang zum SharePoint-Dokument (oder Export als Datei ins Repo).
5. **#83, #92** — Ersatztexte fehlen komplett („Botschaft muss geändert werden" / „Text ändern").
6. **#86** — Welche der beiden Dubletten geht raus, die obere oder die untere?
7. **#88** — Nur Card 1, das ganze Badge-Grid oder die ganze Sektion? (Kunde schreibt „evtl.")
8. **#90** — Alle vier Kennzahlen oder nur die markierte?
9. **#89 + #165** — Darf die IEA zitiert werden? Die Antwort muss für beide Stellen gleich sein.
10. **#102** — Rechte V-Seite optisch zurücknehmen **oder** mit „out of scope" beschriften?
11. **#162** — Welcher der drei Einträge (Support / Technische Unterstützung / Kontakt) bleibt?
12. **#164** — Wie soll der Advanced-Packaging-Block stattdessen aussehen?
13. **#96** — Stimmt die Patent-Aussage zum KI-Systems-Engineering?
14. **#97 + #169** — Seiten wirklich löschen oder nur aus Navigation/Sitemap nehmen? Bei Löschung
    brauchen wir Redirects, sonst entstehen 404er auf indexierten URLs.
15. **#75, #91, #93** — Welcher Bildstil gilt als Referenz, und wer liefert die Bilder?
16. **#95** — Korrekte LinkedIn-URL?
17. **Tippfehler in den gelieferten Texten** — sollen die stillschweigend korrigiert oder
    wörtlich übernommen werden? Gefunden:
    - #120 DE „**Wie** liefern die Grundlage" → vermutlich „Wir liefern"
    - #120 EN „traceable to **ist** rules" → „its rules"
    - #106 EN „traceable to **ist** sources" → „its sources"
    - #123 EN „a decision they can **stanf** behind" → „stand behind"; „people´s hand" → „people's hands"
    - #113 EN „every assessemnt traceable" → „assessment **is** traceable"
    - #116 EN „technology **assessement**" → „assessment"
    - #100 EN „output is **aSystem** Design Concept", „**remeians** with the engineer",
      „qualitatively to **semi-qualitatively**" (DE sagt „semi-quantitativ")
    - #107 EN „dependable early **decisons**", „documented **explicity**", „not from good feeling"
    - #108 EN „risky early **decison**", „documented, **verifable** basis"
18. **#100** — Die EN-Fassung enthält einen Einleitungssatz, den die DE-Fassung nicht hat
    („the impact of decisions is highest and the available data is most limited"). Soll der
    ins Deutsche übernommen werden?
