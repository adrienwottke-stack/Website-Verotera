...
### #83 — Ersatztext für die erste Karte („Vom Chip bis zum System")

Kommentar: „Diese Botschaft muss geändert bzw. angepasst werden." Ein Ersatztext ist nicht
dabei.
...
### #88 — Umfang: eine Karte, das Karten-Raster oder die ganze Sektion?

Kommentar: „Dieser Abschnitt evtl. komplett entfernen." Die Markierung im Screenshot sitzt aber
nur auf dem Titel der ersten Karte.

**Bitte wählen:**
- **A)** Nur diese eine Karte entfernen
- **B)** Das ganze Karten-Raster entfernen (aktuell drei Karten, nachdem die vierte über #161
  bereits raus ist)
...
Kommentar: „Diese Zahlen passen m. E. eher auf eine Präsentation." Markiert ist nur die Karte
„100+ Entwickelte Produkte", der Text spricht aber von „diesen Zahlen" im Plural.

**Bitte wählen:**
- **A)** Nur die markierte Kennzahl entfernen
- **B)** Alle vier Kennzahlen entfernen
- **C)** Die komplette Sektion entfernen, inklusive Gründer-Zitat
...
### #112 — Eyebrow und Überschrift wären wortgleich

#111 ist umgesetzt: Die kleine Pill über der Überschrift heißt jetzt
**„AI-Enhanced WBG Semiconductor Engineering"**. #112 verlangt denselben Text noch einmal für
die große Überschrift direkt darunter — dann stünde derselbe Begriff zweimal untereinander.

**Bitte wählen:**
- **A)** Die Pill behält den Begriff, die Überschrift bekommt einen eigenen Titel — **welchen?**
...
- **C)** Es bleibt die jetzige Reihe, nur größer, mit Nummern und kräftigerem Pfeil

## Seite „WBG Power Modules"

### #91 — Bildstil der Fahrzeug-Grafik

Markiert ist die helle Strichgrafik (Fahrzeug mit SiC-/GaN-Modulen) in der Sektion
„Technologie- & Systempartner". Vorgabe war „Bildstil wie auf der Landingpage" — das trägt
leider noch nicht, weil der Stil dort selbst zur Diskussion steht (#75) und die neuen Dateien
fehlen.

**Bitte klären:** ein konkretes Referenzbild für den Zielstil — und wer liefert den Ersatz für
diese Grafik?

### #92 — Ersatztext unter „Wide-Bandgap at the Core"

Markiert ist der Absatz „VEROTERA begleitet Kunden von den frühesten Entwicklungsphasen an und
co-entwickelt WBG Leistungsmodullösungen der nächsten Generation …". Der Kommentar sagt nur
„Text ändern".
...
Markiert ist das dunkelblaue Render (Wafer unter Laser) neben „Die Brücke zwischen Nachfrage und
Innovation". Der Kommentar sagt „Bild ändern", aber nicht wohin.

**Bitte klären:** Was soll das neue Bild zeigen, und kommt die Datei von euch? Bitte zusammen
mit #91 beantworten, damit beide Bilder im selben Stil landen.

### #95 — LinkedIn-Link funktioniert nicht
...
### #96 — Stimmt die Aussage zum KI-Systems-Engineering?

Markiert ist die Unterzeile „Geschützte Innovationen entlang des gesamten Stacks — vom
Halbleiter über das Packaging bis zum KI-gestützten Systems Engineering." Weiter unten auf der
Seite steht dazu eine eigene Karte („KI-gestütztes Engineering — Methoden im agentischen Systems
Engineering").

**Bitte klären:** Gibt es in diesem Bereich tatsächlich eine Anmeldung? Falls nein: Aussage auf
Halbleiter/Module und Packaging reduzieren, oder ganz streichen?

*Falls die Seite über #97 ohnehin verschwindet, erledigt sich der Punkt — eine kurze Antwort
hilft trotzdem, weil die Formulierung an anderer Stelle wiederverwendet wird.*

### #97 — Patentseite: entlinken oder löschen?

Kommentar: „Ich würde die Landingpage zum Thema Patente erstmal weglassen. Das ist zu früh."
...
## Seite „Technologie Spotlight Galliumnitrid (GaN)"

### #169 — GaN- und SiC-Seite: entlinken oder löschen?

Kommentar: „Die zwei Seiten von GaN und SiC rausnehmen." Gleiche Grundfrage wie bei #97 — hier
mit größerer Wirkung, weil die beiden Seiten an sechs Stellen verlinkt sind: im Menü „Lösungen",
in der Lösungs-Übersicht auf der Startseite, auf der Sitemap-Seite, in der Sitemap für Google und
in vier News-Beiträgen.

**Bitte klären:**
1. **A)** Seiten bleiben online, aber ohne Verlinkung und aus Google genommen (reversibel), oder
   **B)** Seiten löschen — dann mit Weiterleitung auf „WBG Power Modules"
2. Was passiert mit den bestehenden Verlinkungen: komplett entfernen oder stattdessen auf
   „WBG Power Modules" zeigen lassen? Betrifft besonders die vier News-Beiträge, deren
   „Mehr erfahren"-Links sonst ins Leere laufen.
3. Ist das dauerhaft gemeint, oder wie bei #97 nur „erstmal"?
...
Die Sektion trägt jetzt die Überschrift aus #133–#135 („Time-to-Market" / „Time-to-Market
...
*Betrifft zusätzlich die Seite „Automotive & E-Mobility", wo die IEA ebenfalls im Text steht
(in dieser Runde nicht kommentiert).*
...
| **#102** | Die rechte V-Seite ist visuell zurückgenommen (statt sie mit „out of scope" zu beschriften). | Die drei Kacheln im unteren Bereich sind unverändert, weil der Kommentar ausdrücklich „rechte V-Seite" sagt — sollen die mit zurückgenommen werden? |
| **#162** | Von den drei genannten Einträgen ist „Technische Unterstützung" entfernt. „Support" bleibt als Spaltenüberschrift, „Kontakt" bleibt als Link — beide zeigten ohnehin auf dieselbe Seite. | War das der richtige der drei? |

---

# 5. Zwei Kleinigkeiten zur Bestätigung
...
| #120 (EN) | „traceable to **ist** rules" | „traceable to **its** rules" |
| #106 (EN) | „traceable to **ist** sources" | „traceable to **its** sources" |
| #113 (EN) | „every **assessemnt** traceable" | „every **assessment is** traceable" |
| #116 (EN) | „technology **assessement**" | „technology **assessment**" |
| #123 (EN) | „people**´**s hand" · „they can **stanf** behind" | „people**'**s hands" · „they can **stand** behind" |
| #100 (EN) | „**aSystem** Design Concept" · „**remeians** with the engineer" · „semi-**qualitatively**" | „**a System** Design Concept" · „**remains** with the engineer" · „semi-**quantitatively**" (analog zur DE-Fassung) |
