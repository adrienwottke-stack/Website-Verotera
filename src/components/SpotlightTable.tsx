...
const ROWS: Record<Lang, Row[]> = {
  de: [
    ...
    { id: "freq", metric: "Schaltfrequenz", values: { si: "~100–400 kHz", sic: "bis ~300 kHz", gan: "bis in den MHz-Bereich" } },
    { id: "thermal", metric: "Wärmeleitfähigkeit", values: { si: "1,5 W/cmK", sic: "4,9 W/cmK", gan: "1,5 W/cmK" } },
    { id: "voltage", metric: "Max. Spannung (komm.)", values: { si: "~900 V", sic: "bis 3,3 kV", gan: "650 V (1,2 kV emerg.)" } },
    { id: "tj", metric: "Max. Sperrschichttemp. Tj", values: { si: "~150 °C", sic: "175 °C (→200)", gan: "bis ~200 °C" } },
    { id: "cost", metric: "Substratkosten", values: { si: "~$0,1/cm²", sic: "~$7/cm² (6″)", gan: "~$1/cm² (on-Si)" } },
    { id: "ic", metric: "Monolithische IC-Integration", values: { si: "Ausgereift", sic: "Begrenzt", gan: "Ja (HEMT + Treiber)" } },
  ],
  en: [
    { id: "bandgap", metric: "Bandgap", values: { si: "1.1 eV", sic: "3.3 eV", gan: "3.4 eV" } },
    ...
    { id: "freq", metric: "Switching frequency", values: { si: "~100–400 kHz", sic: "up to ~300 kHz", gan: "up to MHz range" } },
    { id: "thermal", metric: "Thermal conductivity", values: { si: "1.5 W/cmK", sic: "4.9 W/cmK", gan: "1.5 W/cmK" } },
    { id: "voltage", metric: "Max. voltage (comm.)", values: { si: "~900 V", sic: "up to 3.3 kV", gan: "650 V (1.2 kV emerg.)" } },
    { id: "tj", metric: "Max. junction temp. Tj", values: { si: "~150 °C", sic: "175 °C (→200)", gan: "up to ~200 °C" } },
    { id: "cost", metric: "Substrate cost", values: { si: "~$0.1/cm²", sic: "~$7/cm² (6″)", gan: "~$1/cm² (on-Si)" } },
    { id: "ic", metric: "Monolithic IC integration", values: { si: "Mature", sic: "Limited", gan: "Yes (HEMT + driver)" } },
  ],
};
...
const QUERIES: Record<Lang, Query[]> = {
  de: [
    ...
    { id: "switching", label: "Hohe Schaltfrequenz", icon: Zap, rows: ["qrr", "freq"], winner: "gan" },
  ...
  en: [
    ...
    { id: "switching", label: "High switching frequency", icon: Zap, rows: ["qrr", "freq"], winner: "gan" },
...
const UI: Record<Lang, { eyebrow: string; hint: string; highlighted: string }> = {
  de: {
          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-semibold border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-cyan/40 ${
                active
                  ? "bg-brand-cyan text-[#020617] border-brand-cyan shadow-sm"
            ...
            <tr className="bg-surface-light border-b border-brand-navy/8">
              ...
              {cols.map((c) => (
                <th key={c.id} className="p-4">
                  ...
                  <span className="block text-[9px] font-bold uppercase tracking-wider text-brand-navy/40">
                    {c.sub}
                  </span>
                </th>
              ))}
