  ...
  const industries = [
    {
      ...
      icon: Car,
      description: "Effiziente, sichere Leistungselektronik für Elektrofahrzeuge. Ermöglicht größere Reichweite, schnellere Ladezyklen und kompaktere Antriebsstränge.",
    ...
    },
    {
      ...
      icon: Sun,
      description: "Hocheffiziente Leistungswandlungssysteme für Solar-, Windenergie und Netzstromversorgung – mit minimierten Koppelungsverlusten.",
    ...
    },
    {
      ...
      icon: Server,
      description: "Hochdichte, thermisch-optimierte Leistungsmodule für KI-Supercomputer und Cloud-Architekturen der nächsten Generation.",
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16 sm:mb-24">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-bold tracking-tight text-brand-navy mb-6">
            Gebaut für die Industrien, die die Elektrifizierung vorantreiben
          </h2>
