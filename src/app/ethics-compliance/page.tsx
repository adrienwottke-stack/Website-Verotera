    ...
    <div className="flex flex-col min-h-screen bg-white text-brand-navy antialiased">
      ...
      <main className="flex-grow">
        <PageHero
          ...
          subtitle="Verantwortungsvolles, integres und regelkonformes Handeln ist die Grundlage des Vertrauens, das unsere Kunden und Partner in VEROTERA setzen."
        />
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="max-w-5xl mx-auto px-6 space-y-8">
            ...
            <div className="glass-panel p-8 space-y-4 text-sm leading-relaxed text-brand-navy/70">
              <h2 className="font-display text-lg font-bold text-brand-navy">Unser Selbstverständnis</h2>
              <p>
                Als Deep-Tech-Unternehmen in der Leistungselektronik tragen wir Verantwortung gegenüber
                Kunden, Mitarbeitenden, Geschäftspartnern und der Gesellschaft. Compliance verstehen wir
                nicht als Pflichtübung, sondern als integralen Bestandteil unserer Unternehmenskultur.
                Unsere Grundsätze gelten für alle Mitarbeitenden und Organe von VEROTERA gleichermaßen.
              </p>
            </div>
            ...
            <div className="glass-panel p-8 space-y-4 text-sm leading-relaxed text-brand-navy/70">
              <h2 className="font-display text-lg font-bold text-brand-navy">Unsere Verpflichtungen</h2>
            ...
            <div className="glass-panel p-8 space-y-4 text-sm leading-relaxed text-brand-navy/70">
              ...
              <p>
                Verstöße gegen geltendes Recht oder unsere internen Richtlinien können vertraulich
                gemeldet werden. Wir gehen jedem Hinweis sorgfältig nach und schützen hinweisgebende
                Personen vor Benachteiligung. Wenden Sie sich dazu bitte an die unten genannte Adresse.
              </p>
